    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <p className="font-[family-name:var(--font-display)] text-7xl text-white mb-3" style={{ textShadow: "0 0 40px rgba(255,255,255,0.3)" }}>digeart</p>
            <p className="font-mono text-white/50 mb-8" style={{ fontSize: 16 }}>{t("welcome.tagline")}</p>
            ...
            {/* Sign in section */}
            <p className="font-mono text-white/40 mb-5" style={{ fontSize: 16 }}>
            ...
            <button
              onClick={onDismiss}
              className="mt-8 font-mono text-white/30 hover:text-white/60 transition-colors cursor-pointer"
              style={{ fontSize: 14 }}
            >
              {t("welcome.skip")}
            </button>
