...
export const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "about.tabs": "Tabs",
    "about.electronic": "Cortes electrónicos del underground",
    "about.djSets": "DJ sets y live sets",
    "about.worldFunk": "World, funk, jazz, ambient y joyas raras",
    ...
    "about.projectPrefix": "un proyecto",
    "about.projectSuffix": "",
  ...
  en: {
    ...
    "about.projectPrefix": "a",
    "about.projectSuffix": "project",
