...
export const translations: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "tutorial.browseYourWayDesc": "Cambia entre Tracks, Samples, Mixes y Tus me gusta para explorar distintos sonidos.",
    ...
    "tutorial.settingsDesc": "Preferencias de la app: tema, idioma, velocidad de reproducción.",
    "tutorial.yourAccount": "Tu cuenta",
    "tutorial.yourAccountDesc": "Todo lo tuyo vive aquí.",
  ...
  en: {
    ...
    "tutorial.settingsDesc": "App preferences: theme, language, playback speed.",
    "tutorial.yourAccount": "Your account",
    "tutorial.yourAccountDesc": "Everything that's yours lives here.",
